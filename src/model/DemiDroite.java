...
public class DemiDroite extends ElementGeometrique {
    ...
    public void dessine(Dessinateur d) {
        ...
        d.dessineDemiDroite((int) (A.getX()), (int) (A.getY()), (int) (B.getX()), (int) (B.getY()));
    }
    ...
    public boolean isOn(double x, double y) {
        ...
        return (dist < ElementGeometrique.delta && prod >= 0);
    }
