...
public class Segment extends ElementGeometrique {
    ...
    public void dessine(Dessinateur d) {
        d.dessineSegment((int) (A.getX()), (int) (A.getY()), (int) (B.getX()), (int) (B.getY()));
    }
    ...
    public boolean isOn(double x, double y) {
        ...
        return dMA + dMB < 2 * Math.sqrt(dAB * dAB / 4 + 100) && (x - A.getX())*(B.getX() - A.getX()) +(y - A.getY())*(B.getY() - A.getY()) > 0 && (x - B.getX())*(A.getX() - B.getX()) +(y - B.getY())*(A.getY() - B.getY()) > 0;
    }
    ...
    public String toString() {
        String ret = "SEGMENT " + String.valueOf(ID) + " " + String.valueOf(A.ID) + " " + String.valueOf(B.ID) + " D ";
